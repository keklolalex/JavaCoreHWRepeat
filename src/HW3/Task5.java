...
public class Task5 {
    public static void main(String[] args) {
        ...
        int game = in.nextInt();
        if (game == 0) System.out.println("выход из программы " + random);
        while (game != 0){
            if (random > game) System.out.println("загаданное число больше " + random);
            if (random < game) System.out.println("загаданное число меньше " + random);
            if (random == game) System.out.println("Вы угадали " + random);
            break;
